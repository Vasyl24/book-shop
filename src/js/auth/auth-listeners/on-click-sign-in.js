...
//   refs.btnGoogle.textContent = 'SIGN IN';
//   refs.btnSignIn.classList.add('is-active');
//   refs.btnSignUp.classList.remove('is-active');
//   refs.inputName.style.visibility = "hidden";
